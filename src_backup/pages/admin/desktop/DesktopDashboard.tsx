...
const DesktopDashboard = () => {
    ...
    const [txLimit, setTxLimit] = useState(50); // Initial limit for history
    ...
    const renderHistory = () => (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col h-[calc(100vh-140px)] animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-7xl mx-auto w-full overflow-hidden">
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-200 text-center">
                 <button 
                    ...
                    className="text-xs font-bold text-slate-500 hover:text-slate-800 hover:bg-white px-4 py-2 rounded-full border border-transparent hover:border-gray-200 transition-all"
                >
                    もっと見る
                 </button>
            </div>
